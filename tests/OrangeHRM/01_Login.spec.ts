...
await expect(page.locator('//label[@class="oxd-label" and text()="Username"]')).toBeVisible();

await page.getByPlaceholder("Username").fill("Admin");
await expect(page.locator('//label[@class="oxd-label" and text()="Password"]')).toBeVisible();
...
await expect(page.getByRole('link', {name:"OrangeHRM, Inc"})).toHaveAttribute('href', /orangehrm/ );
